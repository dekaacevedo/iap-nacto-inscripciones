Rails.application.routes.draw do
  ...
  resources :events do
    ...
    resources :attendee_declarations, only: %i[show new create]
  ...
  resources :attendees, only: %i[new create index destroy edit update]
  resources :event_attendees, only: %i[destroy edit update]

  get 'extra/:id', to: 'attendants#extra', as: 'extra'
  get 'collab_extra/:id', to: 'event_collaborators#extra', as: 'collab_extra'
  get 'attendee_extra/:id', to: 'event_attendees#extra', as: 'attendee_extra'
  get 'success', to: 'success#index'
  get 'full', to: 'success#full', as: 'full'
  get 'ready/:id', to: 'declarations#ready'
  get 'ready2/:id', to: 'attendee_declarations#ready'
